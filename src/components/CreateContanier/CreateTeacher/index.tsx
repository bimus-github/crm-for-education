        ...
        <div className="w-full h-full flex flex-col items-center p-2 bg-white shadow-md">
          ...
          <div className=" w-[580px] h-full flex flex-col items-center">
            ...
            <div className=" w-full flex-[1] h-full flex items-center justify-around">
              <div className=" flex items-center gap-1 justify-start font-serif text-app-secondary-lighter">
                <div
                  onClick={() => setUzb(!uzb)}
                  className="w-[20px] h-[20px] flex justify-center items-center shadow-md rounded-[99px] border-2 border-app-secondary"
                >
                  {uzb && (
